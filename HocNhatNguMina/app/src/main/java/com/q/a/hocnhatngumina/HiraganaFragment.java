 ...
 */
public class HiraganaFragment extends Fragment implements MediaPlayer.OnCompletionListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_hiragana, container, false);

        final GridView gridView = (GridView)rootView.findViewById(R.id.grid_view);
        gridView.setAdapter(new BangChuCaiAdapter(getContext(), true, new AbstractBaseAdapter.ListViewOnItemClickListener() {
            @Override
